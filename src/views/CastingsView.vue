<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <ion-modal :is-open="isNotificationsOpen" @did-dismiss="closeNotifications">
        <notifications-component @close="closeNotifications"></notifications-component>
      </ion-modal>
    </ion-content>
  </ion-page>
</template>
...
import { notifications, share } from 'ionicons/icons'; // Eliminada la importación del icono de chat
...
const isNotificationsOpen = ref(false); // Estado para el modal de notificaciones
